...
class AuthService {
    ...
    func login(withEmail email: String ,password:String)async throws{
        do{
            ...
            print("Debug Failed to login the User with error \(error.localizedDescription) ")
    ...
    func loadUserData() async throws{
        ...
        let snapshot = try await  Firestore.firestore().collection("user").document(currentUid).getDocument()
